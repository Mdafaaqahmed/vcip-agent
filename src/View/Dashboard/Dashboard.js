...
import { UserListAction, PendingListAction } from '../../Store/Actions/DetailsAction';
...
class Dashboard extends Component {
    ...
    componentDidMount() {
        ...
        if (userid) {
            ...
            this.props.PendingListAction($this)
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        PendingListAction: ($this) => dispatch(PendingListAction($this))
