...
import { chatCreateSession, chatCreateToken, RecordingStop, widthHeight } from '../../Store/Actions/UsersActions/ChatAction';
import Aux from '../../hoc';
...
class ChatApp extends Component {
    ...
    capture = (event) => {
        try {
            ...
            this.props.widthHeight(video.videoWidth, video.videoHeight);
    ...
    shuffle_videoScreen = () => {
        if (this.state.toggleBtnCustomer === false) {
            this.setState({
                toggleBtnCustomer: true,
            })
            const model = {
                id: "5",
                msg: true
    ...
    disclaimer = () => {
        ...
        toast.success("Declaration Send Successfully !!")
    }
                        ...
                        <div className="live-video sr1 vheight1 bdr-left bdr-bottom">
                            <div className="customer-video">
                                    ...
                                    {this.props.InfoRdr.singleQuestion[0]?.sno ? (
                                        <div className="qtn-display">
                                            <p className="qtn-display-p">
                                                ...
                                                {console.log(this.props.InfoRdr.singleQuestion[0]?.ques)}
                                                {/* {this.props.InfoRdr.singleQuestion[0]?.sno} . {this.props.InfoRdr.singleQuestion[0]?.ques} */}
                                                {this.props.InfoRdr.singleQuestion[0]?.sno} . {Buffer.from(this.props.InfoRdr.singleQuestion[0]?.ques, "base64").toString()}
                                ...
                                <div className="row box-gap justify-content-center align-items-center">
                                    ...
                                    {this.state.discliamerBtn ? <button onClick={this.disclaimer} className="custom-btn mb-1 mt-1 ml-2" type="button">Disclaimer</button> : <button onClick={this.disclaimer} className="custom-btn mb-1 mt-1 ml-2 disabled" type="button">Disclaimer</button>}

                                    <button className="custom-btn video-btn mt-1 my-0 bg-secondary" name="capture_image" id="first_click" onClick={this.capture}>
                                        <i className="fas fa-camera"></i>
                                    </button>
                                </div>

                                <div className="questions mt-1 box-gap text-center">
                                    <ul className="nav qtn-nav">
                                        ...
                                        <button className="custom-btn video-btn mt-1 my-0 bg-secondary" type="submit" onClick={this.shuffle_videoScreen} id="first_click">
                                ...
                                <div className="modal-body">
                                    <table className="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                {/* console.log(base64.decode(""))                */}

                                                <td colSpan="2">
                                                    Question and answers session:
                                                    <ol className="qtn-list" type={1}>
                                                        {this.props.InfoRdr.questions?.map((qtn, i) => <li key={i}>
                                                            {/* {console.log(atob(qtn.ques))} */}
                                                            {/* {this.decodes(qtn.ques)} */}
                                                            {Buffer.from(qtn.ques, "base64").toString()}

                                                            {/* {console.log(JSON.parse(atob(qtn.ques)))} */}
                                        ...
                                        {(vcipstatus === '3' || vcipstatus === '-2' || vcipstatus === '-3') ?
                                            <div className="form-group">
                                                ...
                                                <select className="form-control" defaultValue={'DEFAULT'} name="remarks" required onChange={this.handleFinish}>
                                                    ...
                                                    <option>Video stream is not happening</option>
