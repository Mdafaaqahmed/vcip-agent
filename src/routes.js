...
import PendingList from "./View/PendingList/PendingList";
import ComingSoon from "./Component/ComingSoon/ComingSoon";
import Dashboard from "./View/Dashboard/Dashboard";
import SchedulePendingList from "./View/SchedulePendingList/SchedulePendingList";
...
const routes = [
    ...
    { path: "/vcipSchedulePendingList", exact: true, name: 'ComingSoon', component: SchedulePendingList },
    // { path: "/next", exact: true, name: 'ComingSoon', component: ComingSoon },
    { path: "/dashboard", exact: true, name: 'Dashboard', component: Dashboard },
    // { path: "/pendinglist", exact: true, name: 'PendingList', component: PendingList },
