...
export const GetInfoAction = (vcipid, $this) => {
    return (dispatch) => {
        ...
        console.log(body, 'getInfoAction')
...
export const GetQuestionsAction = () => {
    return (dispatch) => {
        ...
        Axios.post(URL, parsingData(body))
            .then((res) => {
                var resp = extractData(res.data);
                // console.log(atob(resp.ques));
                // const e = atob(resp.ques)
                // console.log(e);
                if (resp.respcode === "200") {
                    // sort by value
...
// GET ALL PendingListAction FOR AGENT
export const PendingListAction = ($this) => {
    return (dispatch) => {
        ...
        Axios.post(URL, parsingData(body))
            .then((res) => {
                ...
                } else if (resp.respcode === "411") {
                    sessionStorage.clear();
                    toast.warn(resp.respdesc);
                    $this.push("/pendinglist");
